...
class Tags
{
    ...
    public $CI;
    public $tags_ref			= 'tags_ref';
    public $tags				= 'tags';
    public $tags_prefix		= null;
    public $tags_ref_prefix	= null;
    public $siteID				= null;
     ...
     * @return	mixed
     */
    public function fetch_tag($piece=null)
    {
    ...
    public function get_tags($table, $ID)
    {
        // get tags
    ...
    public function get_popular_tags($table, $limit = 10)
    {
        // get tags
    ...
    public function update_tags($table, $ID = '', $tags = '')
    {
        // add tags
        if ($tags) {
            $data = array(
    ...
    public function search($table, $tags = '')
    {
        $tags = explode(' ', $tags);
    ...
    public function tag_cloud($table, $limit = 10, $maxSize = 150, $minSize = 100)
    {
        // get tag data
        $tagdata = array(
            'table' => $table,
     ...
     * @return	array
     */
    public function comma_to_array($string='')
    {
        /*
     ...
     */
    public function make_safe_tag($tag='')
    {
        $tag = strtolower($tag);
