...
class Permission
{
    ...
    public function get_group_permissions_ids($groupID)
    {
        // grab keys
    ...
    public function add_permissions($groupID, $siteID = '')
    {
    ...
    public function add_default_permissions($groupID, $siteID = '')
    {
        // delete all permissions on this groupID first
        if ($siteID) {
            $this->CI->db->where('siteID', $siteID);
    ...
    public function add_group($groupName = '', $siteID = '')
    {
        if ($groupName) {
            if ($siteID) {
                $this->CI->db->set('siteID', $siteID);
