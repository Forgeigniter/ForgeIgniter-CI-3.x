...
*/?>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?=PATH['theme'];?>anvil/img/user2-160x160.jpg" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?=PATH['theme'];?>anvil/img/user2-160x160.jpg" class="img-rounded" alt="User Image">
        </div>
