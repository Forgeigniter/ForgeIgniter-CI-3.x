...
class Admin extends MX_Controller
{
    ...
    public $redirect = '/admin/webforms/tickets';		// default redirect
    public $objectID = 'ticketID';						// default unique ID
    ...
    public function edit_form($formID)
    {
        // check permissions for this page
        if (!in_array('webforms_edit', $this->permission->permissions)) {
            redirect('/admin/dashboard/permissions');
    ...
    public function delete_form($objectID)
    {
        // check permissions for this page
    ...
    public function delete_ticket($objectID)
    {
        // check permissions for this page
