...
class Messages_model extends CI_Model
{
    ...
    public function get_replies($messageID)
    {
        // default where
        $this->db->where('t1.siteID', $this->siteID, false);
        $this->db->where('deleted', 0, false);
    ...
    public function search_messages($query)
    {
        // start cache
        $this->db->start_cache();
    ...
    public function get_recipient($messageID)
    {
        // default where
    ...
    public function add_messagemap($toUserID, $messageID, $parentID = 0)
    {
        // undelete parent
        if ($parentID) {
    ...
    public function unread_message($messageID)
    {
        // get message details
        if ($message = $this->get_message($messageID)) {
            // set parent to read
