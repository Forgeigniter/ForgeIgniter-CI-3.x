		...
		<section class="content">
			...
			<div class="row">
				...
				<div class="col-md-6 pull-right">
					<input type="submit" value="Edit User" name="save" id="save" class="btn btn-green margin-bottom save" />
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="box box-crey nav-tabs-custom">
					...
					<ul class="nav nav-tabs pull-right">
						<li class="pull-left header box-title"><i class="fa fa-edit"></i> Edit New User </li>
