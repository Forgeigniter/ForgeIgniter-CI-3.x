...
class Admin extends MX_Controller
{
    ...
    // set defaults
    public $table = 'users';						// table to update
    public $includes_path = '/includes/admin';		// path to includes for header and footer
    public $redirect = '/admin/users/viewall';		// default redirect
    public $objectID = 'userID';					// default unique ID
    ...
    public function edit_group($groupID)
    {
        // check permissions for this page
        if (!in_array('users_groups', $this->permission->permissions)) {
            redirect('/admin/dashboard/permissions');
