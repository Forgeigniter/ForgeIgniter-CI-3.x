...
class Admin extends CI_Controller
{
    ...
    // set defaults
    public $table = 'images';								// table to update
    public $includes_path = '/includes/admin';				// path to includes for header and footer
    public $redirect = '/admin/images/viewall';			// default redirect
    public $objectID = 'imageID';							// default unique ID
    ...
    public function viewall($folderID = '')
    {
        if (count($_FILES)) {
    ...
    public function edit($imageID, $redirect = '', $popup = false)
    {
        // required
    ...
    public function delete($objectID, $redirect = '')
    {
        // delete image
    ...
    public function popup($encodedID)
    {
