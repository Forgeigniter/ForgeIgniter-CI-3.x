...
class Admin extends MX_Controller
{
    ...
    // set defaults
    public $table = 'files';								// table to update
    public $includes_path = '/includes/admin';				// path to includes for header and footer
    public $redirect = '/admin/files/viewall';			// default redirect
    ...
    public function edit($fileID, $redirect = '', $popup = false)
    {
        // set object ID
