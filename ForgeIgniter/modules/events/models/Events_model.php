...
class Events_Model extends CI_Model
{
    ...
    public function get_post_by_id($eventID)
    {
        $this->db->where('eventID', $eventID);
    ...
    public function update_tags($eventID = '', $tags = '')
    {
        // add tags
        if ($tags) {
    ...
    public function get_events($num = '')
    {
        // default where
        $where = array(
            'deleted' => 0,
    ...
    public function get_events_by_tag($tag, $limit = 10)
    {
    ...
    public function get_events_by_date($year, $month = '', $day = 0)
    {
        if ($month) {
    ...
    public function search_events($query = '', $ids = '')
    {
        if (!$query && !$ids) {
            return false;
        }
