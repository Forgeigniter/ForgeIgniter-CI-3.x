...
class Pages_model extends CI_Model
{
    ...
    public function get_page_children($pageID = '')
    {
        // default where
        $this->db->where('pages.siteID', $this->siteID);
        $this->db->where('deleted', 0);
    ...
    public function get_template_count($templateID)
    {
        // count
    ...
    public function get_template_versions($templateID)
    {
    ...
    public function get_includes($type = '')
    {
        // default where
        $this->db->where('t1.siteID', $this->siteID, false);
        $this->db->where('t1.deleted', 0, false);
    ...
    public function get_include_versions($includeID)
    {
    ...
    public function add_page_nav($pageName, $path)
    {
    ...
    public function import_template($file, $body)
    {
        // set flags
        $success = false;
        $includes = false;
    ...
    public function add_template($templateName, $body, $module = '')
    {
    ...
    public function add_template_version($templateID, $body = '')
    {
        // set body
    ...
    public function revert_template($templateID, $versionID)
    {
    ...
    public function add_include($includeRef, $body, $type, $siteID = true)
    {
    ...
    public function add_include_version($includeID, $body = '')
    {
        // set body
        $body = ($this->input->post('body')) ? $this->input->post('body') : $body;
    ...
    public function revert_include($includeID, $versionID)
    {
    ...
    public function update_children($pageID)
    {
        // update page draft
