...
<section class="content-header">
  ...
  <ol class="breadcrumb">
	...
	<li class="active"><?= (preg_match('/edit/i', $this->uri->segment(3))) ? 'Edit' : 'Add'; ?> View Order</li>
  </ol>
</section>
...
<section class="content container-fluid">
  ...
  <form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>" class="default">
	...
	<div class="row">
		<div class="pull-left">
			<a href="<?php echo site_url('/admin/shop/orders');?>" class="btn btn-crey margin-bottom" style="margin-left: 15px;">Back to Orders</a>
		</div>
